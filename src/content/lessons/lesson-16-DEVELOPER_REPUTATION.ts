...
const content: LessonContent = {
  ...
  explanation: `## Lesson 16 — Buying a Listing
...
`,
  task: `Add \`buy_listing(self, listing_id: str)\` with \`@gl.public.write.payable\`. Validate: listing exists, active, buyer != seller, value >= price. Store buyer and escrow, set statuses to "pending".`,
  hints: [
