...
`,
  task: `Ensure your contract includes: get_dao_name, get_owner, create_proposal, get_proposal_json, get_open_proposals_json, vote, execute_proposal, analyze_proposal_with_ai, get_frontend_actions_json, get_test_checklist_json.`,
  hints: [
