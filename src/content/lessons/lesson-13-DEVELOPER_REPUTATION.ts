...
const content: LessonContent = {
  ...
  explanation: `## Lesson 13 — Active Listings View
...
`,
  task: `Add \`get_active_listings_json(self) -> str\` looping \`listing_ids\` and filtering for status "active". Include id, title, price.`,
  hints: [
