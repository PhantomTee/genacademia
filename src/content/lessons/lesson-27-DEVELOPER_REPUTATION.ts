...
const content: LessonContent = {
  ...
  explanation: `## Lesson 27 — Frontend Integration for Marketplace
...
`,
  task: `Add \`get_frontend_actions_json()\` mapping: create, list, detail, buy, confirm, source, evaluate, remove.`,
  hints: [
