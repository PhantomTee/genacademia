...
const content: LessonContent = {
  ...
  explanation: `## Lesson 23 — Comparative AI Validation
...
class CodeVault(gl.Contract):
    ...
    def evaluate_listing_with_ai(self, listing_id: str) -> str:
        ...
        return result
`,
  task: `Inside \`evaluate_listing_with_ai\`'s \`run\` function, add \`import re\` and extract the JSON object from the AI response.`,
  hints: [
