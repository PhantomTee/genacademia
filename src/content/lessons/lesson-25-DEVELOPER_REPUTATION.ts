...
const content: LessonContent = {
  ...
  explanation: `## Lesson 25 — Major Upgrade: AI Listing Judge
...
class CodeVault(gl.Contract):
    ...
    def evaluate_listing_with_ai(self, listing_id: str) -> str:
        ...
        return result
`,
  task: `Add \`get_ai_verdict(self, listing_id: str) -> str\` as a \`@gl.public.view\` returning the stored verdict or "not evaluated yet".`,
  hints: [
