...
const content: LessonContent = {
  ...
  explanation: `## Lesson 14 — Job Status Flow
...
class TrustLance(gl.Contract):
    ...
    def get_open_jobs_json(self) -> str:
        ...
        return json.dumps(result, sort_keys=True)
`,
  task: `Add \`close_job(self, job_id: str)\` decorated with \`@gl.public.write\`. Only the client can close a job, and only if it's "open".`,
  hints: [
