...
const content: LessonContent = {
  ...
  explanation: `## Lesson 21 — AI Code Preview Review
...
`,
  task: `Add \`get_listing_ai_prompt(self, listing_id: str) -> str\` as a \`@gl.public.view\`. Build a prompt with the listing title, description, and preview.`,
  hints: [
    "Build an f-string combining title, description, and preview.",
    "Include clear instructions for what the AI should assess.",
    "Key line: `return f'Title: {title}/nDescription: {description}/nPreview: {preview}'`",
  ],
};
