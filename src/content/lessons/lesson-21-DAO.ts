...
const content: LessonContent = {
  lessonId: 21,
  projectPath: "DAO",
  explanation: `## Lesson 21 — AI Proposal Summary
...
`,
  task: `Add \`get_proposal_ai_prompt(self, proposal_id: str) -> str\` as a \`@gl.public.view\`. Return a string that includes the proposal title, description, and current vote counts.`,
  hints: [
    "Build a multi-line f-string including all relevant proposal data.",
    "Include title, description, for_votes, and against_votes.",
    "Key line: `return f'Title: {title}/nDescription: {description}/nFor: {fv}, Against: {av}'`",
  ],
};
