...
const content: LessonContent = {
  ...
  explanation: `## Lesson 24 — Structured Dispute Output
...
class TrustLance(gl.Contract):
    ...
    def review_dispute_with_ai(self, job_id: str, reason: str) -> str:
        ...
        return result
`,
  task: `Update the AI prompt in \`review_dispute_with_ai\` to explicitly request JSON output with \`verdict\`, \`confidence\`, and \`reason\` fields. Add a \`dispute_outcomes: TreeMap[str, str]\` field to store results.`,
  hints: [
