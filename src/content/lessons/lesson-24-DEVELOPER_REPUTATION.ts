...
const content: LessonContent = {
  ...
  explanation: `## Lesson 24 — Structured AI Listing Verdict
...
class CodeVault(gl.Contract):
    ...
    def evaluate_listing_with_ai(self, listing_id: str) -> str:
        ...
        return result
`,
  task: `Update the AI prompt to explicitly request JSON with \`verdict\`, \`quality_score\`, \`explanation\`. Store the result in \`listing_ai_verdicts[listing_id]\`.`,
  hints: [
