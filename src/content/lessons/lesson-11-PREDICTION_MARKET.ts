...
You'll learn that a counter alone is not enough for frontend listing. The contract needs an index of market IDs.`,
...
self.market_ids.append(market_id)`,
  hints: [
    "Add:.",
    "market_ids: DynArray[str]",
    "Key line: `self.market_ids.append(market_id)`",
  ],
};
