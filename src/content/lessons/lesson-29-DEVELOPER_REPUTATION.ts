...
`,
  task: `Ensure your contract includes: get_platform_name, get_owner, create_listing, get_listing_json, get_active_listings_json, buy_listing, confirm_purchase, get_source_hash, evaluate_listing_with_ai, get_frontend_actions_json, get_test_checklist_json.`,
  hints: [
