...
const content: LessonContent = {
  ...
  explanation: `## Lesson 26 — Escrow Safety Mistakes
...
`,
  task: `Add a guard inside \`review_dispute_with_ai\`: assert job has been delivered before allowing AI review. Add message: "Job must be delivered first".`,
  hints: [
