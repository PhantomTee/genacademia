...
`,
  task: `Deploy the final contract. Confirm: identity, listing creation, indexing, JSON views, escrow purchase, source reveal gate, AI evaluation, and test checklist all work.`,
  hints: [
