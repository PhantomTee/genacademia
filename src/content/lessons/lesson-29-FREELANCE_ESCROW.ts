...
`,
  task: `Review your contract and ensure it includes all required methods: get_platform_name, get_owner, create_job, get_job_json, get_open_jobs_json, fund_job, accept_job, submit_delivery, confirm_delivery, review_dispute_with_ai, get_frontend_actions_json, get_test_checklist_json.`,
  hints: [
